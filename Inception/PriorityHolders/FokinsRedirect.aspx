<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FokinsRedirect.aspx.cs" Inherits="Inception.PriorityHolders.Fokinstest" %>
...
<head runat="server">
    ...
    <title>Bindra Family | Maharashtra Tour 2015</title>
    <meta charset="UTF-8" />
    ...
    <form id="form1" runat="server">
        ...
        <div class="headcont slideInDown animated">
            <div>
             ...
             <div class="albdesc"> 
                   <h1 class="albcovhead">Maharashtra Tour<br /> <span id="smalmer">There come but very few chances to have fun with cousins.<br />Availing the opportunity this time
                       I would say it was not a bad choice.<br /> Maharashtra was aswesome.
                                                                 </span></h1>
            
             </div>

                <div class="buttonsing wow bounce animated" data-wow-delay=".5s" data-wow-duration="1s">
                    <asp:ImageButton runat="server" ID="refresher" ToolTip="Refresh" Height="40px" BorderWidth="0px" Width="40px" PostBackUrl="~/PriorityHolders/FokinsRedirect.aspx" CssClass="fae" ImageUrl="~/white/refresh.png" OnClick="refresher_Click" />
                                ...
                                <div class="es-carousel">
                                  ...
                                  <li><a href="#">
                                   ...
                                   <li><a href="#">
                                    ...
                                    <li><a href="#">
                                            <img src="images/thumbs/31.jpg" data-large="images/31.jpg" alt="image01" data-description="From off a hill whose concave womb reworded" /></a></li>
                                        <li><a href="#">
                                            <img src="images/thumbs/32.jpg" data-large="images/32.jpg" alt="image02" data-description="A plaintful story from a sistering vale" /></a></li>
                                        <li><a href="#">
                                            <img src="images/thumbs/33.jpg" data-large="images/33.jpg" alt="image03" data-description="A plaintful story from a sistering vale" /></a></li>
                                        <li><a href="#">
                                            <img src="images/thumbs/34.jpg" data-large="images/34.jpg" alt="image04" data-description="My spirits to attend this double voice accorded" /></a></li>
                                        <li><a href="#">
                                            <img src="images/thumbs/35.jpg" data-large="images/35.jpg" alt="image05" data-description="And down I laid to list the sad-tuned tale" /></a></li>
                                        <li><a href="#">
                                            <img src="images/thumbs/36.jpg" data-large="images/36.jpg" alt="image06" data-description="Ere long espied a fickle maid full pale" /></a></li>
                                        <li><a href="#">
                                            <img src="images/thumbs/37.jpg" data-large="images/37.jpg" alt="image07" data-description="Tearing of papers, breaking rings a-twain" /></a></li>
                                        <li><a href="#">
                                            <img src="images/thumbs/38.jpg" data-large="images/38.jpg" alt="image08" data-description="Storming her world with sorrow's wind and rain" /></a></li>
                                        <li><a href="#">
                                            <img src="images/thumbs/39.jpg" data-large="images/39.jpg" alt="image09" data-description="Upon her head a platted hive of straw" /></a></li>
                                        <li><a href="#">
                                            <img src="images/thumbs/40.jpg" data-large="images/40.jpg" alt="image10" data-description="Which fortified her visage from the sun" /></a></li>
                                        <li><a href="#">
                                            <img src="images/thumbs/41.jpg" data-large="images/41.jpg" alt="image11" data-description="Whereon the thought might think sometime it saw" /></a></li>
                                        <li><a href="#">
                                            <img src="images/thumbs/42.jpg" data-large="images/42.jpg" alt="image12" data-description="The carcass of beauty spent and done" /></a></li>
                                        <li><a href="#">
                                            <img src="images/thumbs/43.jpg" data-large="images/43.jpg" alt="image13" data-description="Time had not scythed all that youth begun" /></a></li>
                                        <li><a href="#">
                                            <img src="images/thumbs/44.jpg" data-large="images/44.jpg" alt="image14" data-description="Nor youth all quit; but, spite of heaven's fell rage" /></a></li>
                                        <li><a href="#">
                                            <img src="images/thumbs/45.jpg" data-large="images/45.jpg" alt="image15" data-description="Some beauty peep'd through lattice of sear'd age" /></a></li>
                                        <li><a href="#">
                                            <img src="images/thumbs/46.jpg" data-large="images/46.jpg" alt="image16" data-description="Oft did she heave her napkin to her eyne" /></a></li>
                                        <li><a href="#">
                                            <img src="images/thumbs/47.jpg" data-large="images/47.jpg" alt="image17" data-description="Which on it had conceited characters" /></a></li>
                                        <li><a href="#">
                                            <img src="images/thumbs/48.jpg" data-large="images/48.jpg" alt="image18" data-description="Laundering the silken figures in the brine" /></a></li>
                                        <li><a href="#">
                                            <img src="images/thumbs/49.jpg" data-large="images/49.jpg" alt="image19" data-description="That season'd woe had pelleted in tears" /></a></li>
                                        <li><a href="#">
                                            <img src="images/thumbs/50.jpg" data-large="images/50.jpg" alt="image20" data-description="And often reading what contents it bears" /></a></li>
                                        <li><a href="#">
                                            <img src="images/thumbs/51.jpg" data-large="images/51.jpg" alt="image21" data-description="As often shrieking undistinguish'd woe" /></a></li>
                                        <li><a href="#">
                                            <img src="images/thumbs/52.jpg" data-large="images/52.jpg" alt="image22" data-description="In clamours of all size, both high and low" /></a></li>
                                        <li><a href="#">
                                            <img src="images/thumbs/53.jpg" data-large="images/53.jpg" alt="image23" data-description="Sometimes her levell'd eyes their carriage ride" /></a></li>
                                        <li><a href="#">
                                            <img src="images/thumbs/54.jpg" data-large="images/54.jpg" alt="image24" data-description="As they did battery to the spheres intend" /></a></li>
                                         <li><a href="#">
                                            <img src="images/thumbs/55.jpg" data-large="images/55.jpg" alt="image25" data-description="nAs tnhey dnid battery to the nspheres inntnennd" /></a></li>
                                        <li><a href="#">
                                            <img src="images/thumbs/56.jpg" data-large="images/56.jpg" alt="image26" data-description="nAs tnhey dnifd battery to thed nspheres innffhsdfhtnennd" /></a></li>
                                  <li><a href="#">
                                            <img src="images/thumbs/57.jpg" data-large="images/57.jpg" alt="image27" data-description="nAs tnhey dnifd battery to thed nspheres innffhsdfhtnennd" /></a></li>
                                  <li><a href="#">
                                            <img src="images/thumbs/58.jpg" data-large="images/58.jpg" alt="image28" data-description="nAs tnhey dnifd battery to thed nspheres innffhsdfhtnennd" /></a></li>
                                  <li><a href="#">
                                            <img src="images/thumbs/59.jpg"  data-large="images/59.jpg" alt="image29" data-description="nAs tnhey dnifd battery to thed nspheres innffhsdfhtnennd" /></a></li>
                                   <li><a href="#">
                                            <img src="images/thumbs/60.jpg"  data-large="images/60.jpg" alt="image29" data-description="nAs tnhey dnifd battery to thed nspheres innffhsdfhtnennd" /></a></li>
                                 <li><a href="#">
                                            <img src="images/thumbs/61.jpg"  data-large="images/61.jpg" alt="image29" data-description="nAs tnhey dnifd battery to thed nspheres innffhsdfhtnennd" /></a></li>
