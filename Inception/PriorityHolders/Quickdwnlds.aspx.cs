...
namespace Inception.PriorityHolders
{
    public partial class WebForm1 : System.Web.UI.Page
    {
        ...
        protected void downlaoderi_Click(object sender, ImageClickEventArgs e)
        {
            ...
            Response.AppendHeader("Content-Disposition", "attachent; filename=BindraFamily.com_QuickDownloads.zip");
            Response.TransmitFile("~/Downloadables/Quickds.zip");
            Response.End();
        ...
        {
            Response.ContentType = "folder/zip";
            Response.AppendHeader("Content-Disposition", "attachment; filename=BindraFamily.com_QuickDownloads(HQ).zip");
            Response.TransmitFile("~/Downloadables/QuickdsHQ.zip");
            Response.End();
        }
    }
}