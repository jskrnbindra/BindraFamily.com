<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ShailloRedirect.aspx.cs" Inherits="Inception.Bancrofti.tempShaillus" %>
...
<head runat="server">
    ...
    <link rel="shortcut icon" href="~/Bancrofti/favicon.ico" type="image/x-icon" />
    ...
    <title>Bindra Family | The Secret Member</title>
    <meta charset="UTF-8" />
...
<body>
    ...
    <div style="position:absolute;left:550px;top:70px;z-index:9;">  <asp:Image runat="server" ID="lover" ImageUrl="~/Bancrofti/heart8.jpg" /></div>
        ...
        <div class="headcont slideInDown animated">
            <div>
             ...
             <div class="albdesc"> 
                   <h1 class="albcovhead">My Shaillo <3<br /> <span id="smalmer">Its amazing how just a mere mention of your name gives me butterflies.<br />
                      The only time I'll be on my knees would be to express my love for you.<br />
                ...
                <div class="buttonsing wow bounce animated" data-wow-delay=".5s" data-wow-duration="1s">
                    <asp:ImageButton runat="server" ID="refresher" ToolTip="Refresh" Height="40px" BorderWidth="0px" Width="40px" PostBackUrl="~/Bancrofti/ShailloRedirect.aspx" CssClass="fae" ImageUrl="~/white/refresh.png" OnClick="refresher_Click" />
                        ...
                        <div class="rg-thumbs">
                            ...
                            <div class="es-carousel-wrapper">
                                ...
                                <div class="es-carousel">
                                  ...
                                  <li><a href="#">
                                            <img src="images/thumbs/29.jpg" data-large="images/29.jpg" alt="image28" data-description="nAs tnhey dnifd battery to thed nspheres innffhsdfhtnennd" /></a></li>
