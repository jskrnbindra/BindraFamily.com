...
namespace Inception.SuperUsers
{
    public partial class WebForm1 : System.Web.UI.Page
    {
        ...
        protected void downlaoderi_Click(object sender, ImageClickEventArgs e)
        {
            ...
            Response.AppendHeader("Content-Disposition", "attachent; filename=BindraFamily.com_HomelyClicks.zip");
            Response.TransmitFile("~/Downloadables/Owners.zip");
            Response.End();
        ...
        {
            Response.ContentType = "folder/zip";
            Response.AppendHeader("Content-Disposition", "attachment; filename=BindraFamily.com_HomelyClicks(HQ).zip");
            Response.TransmitFile("~/Downloadables/OwnersHQ.zip");
            Response.End();
        }
    }
}